...
scheduler.every '1m', :first_in => 0, :overlap => false do
  ...
  # puts scrape.inspect
  # scrape = HTTParty.get("https://sports.yahoo.com/college-football/scoreboard/?schedState=2&dateRange=5&confId=1%2C4%2C6%2C7%2C8%2C11%2C71%2C72%2C87%2C90%2C122")
  # scrape = HTTParty.get("https://sports.yahoo.com/college-football/scoreboard/?schedState=2&dateRange=5")
